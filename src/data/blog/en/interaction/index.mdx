---
title: Testing for Interaction and Main Effect in Statistical Analysis with a Public Dataset
description:    Learn how to test for main effects and interactions using Python's statsmodels with the public Tips dataset.
draft: false
authors:
  - main-author
pubDate: 2023-07-21
heroImage: ../interaction/interaction.png
categories:
  - machine-learning
  - python
  - data-science
